...
//=========  (Sat Oct 31 02:03:28 2015) by ROOT version5.32/00
   ...
   TH1D *frame_1aa12f0__3 = new TH1D("frame_1aa12f0__3","",40,0,800);
   frame_1aa12f0__3->SetMaximum(933.2536);
   frame_1aa12f0__3->SetDirectory(0);
   frame_1aa12f0__3->SetStats(0);
   frame_1aa12f0__3->SetFillColor(2);
   frame_1aa12f0__3->SetFillStyle(0);
   frame_1aa12f0__3->SetLineStyle(0);
   frame_1aa12f0__3->SetLineWidth(2);
   frame_1aa12f0__3->SetMarkerStyle(20);
   frame_1aa12f0__3->SetMarkerSize(1.2);
   frame_1aa12f0__3->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_1aa12f0__3->GetXaxis()->SetNdivisions(505);
   frame_1aa12f0__3->GetXaxis()->SetLabelFont(42);
   frame_1aa12f0__3->GetXaxis()->SetLabelSize(0.05);
   frame_1aa12f0__3->GetXaxis()->SetTitleSize(0.055);
   frame_1aa12f0__3->GetXaxis()->SetTitleOffset(1.2);
   frame_1aa12f0__3->GetXaxis()->SetTitleFont(42);
   frame_1aa12f0__3->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_1aa12f0__3->GetYaxis()->SetLabelFont(42);
   frame_1aa12f0__3->GetYaxis()->SetLabelOffset(0.01);
   frame_1aa12f0__3->GetYaxis()->SetLabelSize(0.05);
   frame_1aa12f0__3->GetYaxis()->SetTitleSize(0.055);
   frame_1aa12f0__3->GetYaxis()->SetTitleOffset(1.4);
   frame_1aa12f0__3->GetYaxis()->SetTitleFont(42);
   frame_1aa12f0__3->GetZaxis()->SetLabelFont(42);
   frame_1aa12f0__3->GetZaxis()->SetLabelSize(0.035);
   frame_1aa12f0__3->GetZaxis()->SetTitleSize(0.035);
   frame_1aa12f0__3->GetZaxis()->SetTitleFont(42);
   frame_1aa12f0__3->Draw("");
   ...
   grae->SetPoint(6,130,300);
   grae->SetPointError(6,10,10,16.82772,17.82772);
   grae->SetPoint(7,150,532);
   grae->SetPointError(7,10,10,22.57054,23.57054);
   grae->SetPoint(8,170,859);
   grae->SetPointError(8,10,10,28.81297,29.81297);
   grae->SetPoint(9,190,575);
   grae->SetPointError(9,10,10,23.48437,24.48437);
   grae->SetPoint(10,210,316);
   grae->SetPointError(10,10,10,17.28342,18.28342);
   grae->SetPoint(11,230,298);
   grae->SetPointError(11,10,10,16.76992,17.76992);
   grae->SetPoint(12,250,237);
   grae->SetPointError(12,10,10,14.90292,15.90292);
   grae->SetPoint(13,270,200);
   grae->SetPointError(13,10,10,13.65097,14.65097);
   grae->SetPoint(14,290,179);
   grae->SetPointError(14,10,10,12.88843,13.88843);
   grae->SetPoint(15,310,148);
   grae->SetPointError(15,10,10,11.6758,12.6758);
   grae->SetPoint(16,330,134);
   grae->SetPointError(16,10,10,11.08663,12.08663);
   grae->SetPoint(17,350,133);
   grae->SetPointError(17,10,10,11.0434,12.0434);
   grae->SetPoint(18,370,104);
   grae->SetPointError(18,10,10,9.710289,10.71029);
   grae->SetPoint(19,390,96);
   grae->SetPointError(19,10,10,9.780867,10.83201);
   grae->SetPoint(20,410,83);
   grae->SetPointError(20,10,10,9.092044,10.14705);
   grae->SetPoint(21,430,70);
   grae->SetPointError(21,10,10,8.346566,9.406468);
   grae->SetPoint(22,450,68);
   grae->SetPointError(22,10,10,8.225883,9.28666);
   grae->SetPoint(23,470,63);
   grae->SetPointError(23,10,10,7.916129,8.979274);
   ...
   Graph_h_dataFail2->SetMaximum(977.6943);
   ...
   TH1D *frame_1aa12f0__4 = new TH1D("frame_1aa12f0__4","",40,0,800);
   frame_1aa12f0__4->SetMaximum(933.2536);
   frame_1aa12f0__4->SetDirectory(0);
   frame_1aa12f0__4->SetStats(0);
   frame_1aa12f0__4->SetFillColor(2);
   frame_1aa12f0__4->SetFillStyle(0);
   frame_1aa12f0__4->SetLineStyle(0);
   frame_1aa12f0__4->SetLineWidth(2);
   frame_1aa12f0__4->SetMarkerStyle(20);
   frame_1aa12f0__4->SetMarkerSize(1.2);
   frame_1aa12f0__4->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_1aa12f0__4->GetXaxis()->SetNdivisions(505);
   frame_1aa12f0__4->GetXaxis()->SetLabelFont(42);
   frame_1aa12f0__4->GetXaxis()->SetLabelSize(0.05);
   frame_1aa12f0__4->GetXaxis()->SetTitleSize(0.055);
   frame_1aa12f0__4->GetXaxis()->SetTitleOffset(1.2);
   frame_1aa12f0__4->GetXaxis()->SetTitleFont(42);
   frame_1aa12f0__4->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_1aa12f0__4->GetYaxis()->SetLabelFont(42);
   frame_1aa12f0__4->GetYaxis()->SetLabelOffset(0.01);
   frame_1aa12f0__4->GetYaxis()->SetLabelSize(0.05);
   frame_1aa12f0__4->GetYaxis()->SetTitleSize(0.055);
   frame_1aa12f0__4->GetYaxis()->SetTitleOffset(1.4);
   frame_1aa12f0__4->GetYaxis()->SetTitleFont(42);
   frame_1aa12f0__4->GetZaxis()->SetLabelFont(42);
   frame_1aa12f0__4->GetZaxis()->SetLabelSize(0.035);
   frame_1aa12f0__4->GetZaxis()->SetTitleSize(0.035);
   frame_1aa12f0__4->GetZaxis()->SetTitleFont(42);
   frame_1aa12f0__4->Draw("AXISSAME");
