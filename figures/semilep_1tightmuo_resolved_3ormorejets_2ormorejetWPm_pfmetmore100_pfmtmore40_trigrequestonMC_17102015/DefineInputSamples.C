...
void DefineInputSamples(vector<CSample*> *samplev, string inputdir, string inputdirQCD, bool splitttbar, int singlelepdata, bool blind, int mask){
  ...
  if(!blind){
    ...
    if(singlelepdata==1)
      samplev->back()->fnamev.push_back("../"+inputdir+"/SingleMu_2012-22Jan2013_allhadrbits.root");
  ...
  if((mask & 0000001) == 0000001){
    ...
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_WW_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_WZJetsTo3LNu_TuneZ2_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_WZJetsTo2L2Q_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_WZJetsTo2QLNu_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZZJetsTo2Q2Nu_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZZJetsTo2L2Q_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZZJetsTo2L2Nu_TuneZ2star_allhadrbits.root");
  }
  // Z+jets
  if((mask & 0x0000010) == 0x0000010){
    samplev->push_back(new CSample("Z+jets",kOrange-2,kOrange-3));
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_DY0JetsToLL_M-50_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_DY1JetsToLL_M-50_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_DY2JetsToLL_M-50_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_DY3JetsToLL_M-50_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_DY4JetsToLL_M-50_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZJetsToNuNu_50_HT_100_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZJetsToNuNu_100_HT_200_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZJetsToNuNu_200_HT_400_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_ZJetsToNuNu_400_HT_inf_allhadrbits.root");
  }            
  //single top
  if((mask & 0x0000100) == 0x0000100){
    samplev->push_back(new CSample("single t",kAzure-8,kBlue-6));
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_T_tW-channel-DR_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_Tbar_tW-channel-DR_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_T_s-channel_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_Tbar_s-channel_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_T_t-channel_TuneZ2star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_Tbar_t-channel_TuneZ2star_allhadrbits.root");
  }
  //W+jets 
  if((mask & 0x0001000) == 0x0001000){
    samplev->push_back(new CSample("W+jets",kOrange+7,kOrange+10));
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_W0JetsToLNu_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_W1JetsToLNu_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_W2JetsToLNu_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_W3JetsToLNu_TuneZ2Star_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_W4JetsToLNu_TuneZ2Star_allhadrbits.root");
  }   
  ...
  if((mask & 0x0010000) == 0x0010000){
    ...
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTJets_FullLeptMGDecays_allhadrbits.root");
    cout<<"splitttbar "<<splitttbar<<endl;
    if(splitttbar)
      samplev->push_back(new CSample("t#bar{t} Semi",kGreen+2,kGreen+3));
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTJets_SemiLeptMGDecays_allhadrbits.root");
    if(splitttbar)
   samplev->push_back(new CSample("t#bar{t} AllHadr,t#bar{t}XJets",kCyan+2,kCyan+3));
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTJets_HadronicMGDecays_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTGJets_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTWJets_allhadrbits.root");
    samplev->back()->fnamev.push_back("../"+inputdir+"/Summer12_TTZJets_allhadrbits.root");
  }
 ...
 // // samplev->push_back(new CSample("QCD500to1000",kGray+2,kGray+3));
 // // //  samplev->back()->fnamev.push_back("../"+inputdirQCD+"/Summer12_QCD_HT-1000ToInf_TuneZ2star_allhadrbits.root");
 // // samplev->back()->fnamev.push_back("../"+inputdirQCD+"/Summer12_QCD_HT-500To1000_TuneZ2star_allhadrbits.root");

 // // samplev->push_back(new CSample("QCD1000t0Inf",kGray+2,kGray+3));
 // // samplev->back()->fnamev.push_back("../"+inputdirQCD+"/Summer12_QCD_HT-1000ToInf_TuneZ2star_allhadrbits.root");
 // // 
