...
//=========  (Tue Oct 27 00:01:42 2015) by ROOT version5.32/00
   ...
   cfail_bf->Range(-150,-333.4627,850,2231.635);
   ...
   TH1D *frame_1643e90__3 = new TH1D("frame_1643e90__3","",40,0,800);
   frame_1643e90__3->SetMaximum(2026.428);
   frame_1643e90__3->SetDirectory(0);
   frame_1643e90__3->SetStats(0);
   frame_1643e90__3->SetFillColor(2);
   frame_1643e90__3->SetFillStyle(0);
   frame_1643e90__3->SetLineStyle(0);
   frame_1643e90__3->SetLineWidth(2);
   frame_1643e90__3->SetMarkerStyle(20);
   frame_1643e90__3->SetMarkerSize(1.2);
   frame_1643e90__3->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_1643e90__3->GetXaxis()->SetNdivisions(505);
   frame_1643e90__3->GetXaxis()->SetLabelFont(42);
   frame_1643e90__3->GetXaxis()->SetLabelSize(0.05);
   frame_1643e90__3->GetXaxis()->SetTitleSize(0.055);
   frame_1643e90__3->GetXaxis()->SetTitleOffset(1.2);
   frame_1643e90__3->GetXaxis()->SetTitleFont(42);
   frame_1643e90__3->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_1643e90__3->GetYaxis()->SetLabelFont(42);
   frame_1643e90__3->GetYaxis()->SetLabelOffset(0.01);
   frame_1643e90__3->GetYaxis()->SetLabelSize(0.05);
   frame_1643e90__3->GetYaxis()->SetTitleSize(0.055);
   frame_1643e90__3->GetYaxis()->SetTitleOffset(1.4);
   frame_1643e90__3->GetYaxis()->SetTitleFont(42);
   frame_1643e90__3->GetZaxis()->SetLabelFont(42);
   frame_1643e90__3->GetZaxis()->SetLabelSize(0.035);
   frame_1643e90__3->GetZaxis()->SetTitleSize(0.035);
   frame_1643e90__3->GetZaxis()->SetTitleFont(42);
   frame_1643e90__3->Draw("");
   ...
   grae->SetPoint(5,110,308);
   grae->SetPointError(5,10,10,17.05705,18.05705);
   grae->SetPoint(6,130,569);
   grae->SetPointError(6,10,10,23.35896,24.35896);
   grae->SetPoint(7,150,975);
   grae->SetPointError(7,10,10,30.72899,31.72899);
   grae->SetPoint(8,170,1886);
   grae->SetPointError(8,10,10,42.93098,43.93098);
   grae->SetPoint(9,190,1822);
   grae->SetPointError(9,10,10,42.18782,43.18782);
   grae->SetPoint(10,210,1102);
   grae->SetPointError(10,10,10,32.70015,33.70015);
   grae->SetPoint(11,230,832);
   grae->SetPointError(11,10,10,28.34874,29.34874);
   grae->SetPoint(12,250,622);
   grae->SetPointError(12,10,10,24.44494,25.44494);
   grae->SetPoint(13,270,544);
   grae->SetPointError(13,10,10,22.82917,23.82917);
   grae->SetPoint(14,290,469);
   grae->SetPointError(14,10,10,21.16218,22.16218);
   grae->SetPoint(15,310,416);
   grae->SetPointError(15,10,10,19.90221,20.90221);
   grae->SetPoint(16,330,345);
   grae->SetPointError(16,10,10,18.0809,19.0809);
   grae->SetPoint(17,350,308);
   grae->SetPointError(17,10,10,17.05705,18.05705);
   grae->SetPoint(18,370,276);
   grae->SetPointError(18,10,10,16.12077,17.12077);
   grae->SetPoint(19,390,236);
   grae->SetPointError(19,10,10,14.87043,15.87043);
   ...
   grae->SetPoint(22,450,163);
   grae->SetPointError(22,10,10,12.27693,13.27693);
   ...
   Graph_h_dataFail2->SetMaximum(2122.924);
   ...
   TH1D *frame_1643e90__4 = new TH1D("frame_1643e90__4","",40,0,800);
   frame_1643e90__4->SetMaximum(2026.428);
   frame_1643e90__4->SetDirectory(0);
   frame_1643e90__4->SetStats(0);
   frame_1643e90__4->SetFillColor(2);
   frame_1643e90__4->SetFillStyle(0);
   frame_1643e90__4->SetLineStyle(0);
   frame_1643e90__4->SetLineWidth(2);
   frame_1643e90__4->SetMarkerStyle(20);
   frame_1643e90__4->SetMarkerSize(1.2);
   frame_1643e90__4->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_1643e90__4->GetXaxis()->SetNdivisions(505);
   frame_1643e90__4->GetXaxis()->SetLabelFont(42);
   frame_1643e90__4->GetXaxis()->SetLabelSize(0.05);
   frame_1643e90__4->GetXaxis()->SetTitleSize(0.055);
   frame_1643e90__4->GetXaxis()->SetTitleOffset(1.2);
   frame_1643e90__4->GetXaxis()->SetTitleFont(42);
   frame_1643e90__4->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_1643e90__4->GetYaxis()->SetLabelFont(42);
   frame_1643e90__4->GetYaxis()->SetLabelOffset(0.01);
   frame_1643e90__4->GetYaxis()->SetLabelSize(0.05);
   frame_1643e90__4->GetYaxis()->SetTitleSize(0.055);
   frame_1643e90__4->GetYaxis()->SetTitleOffset(1.4);
   frame_1643e90__4->GetYaxis()->SetTitleFont(42);
   frame_1643e90__4->GetZaxis()->SetLabelFont(42);
   frame_1643e90__4->GetZaxis()->SetLabelSize(0.035);
   frame_1643e90__4->GetZaxis()->SetTitleSize(0.035);
   frame_1643e90__4->GetZaxis()->SetTitleFont(42);
   frame_1643e90__4->Draw("AXISSAME");
