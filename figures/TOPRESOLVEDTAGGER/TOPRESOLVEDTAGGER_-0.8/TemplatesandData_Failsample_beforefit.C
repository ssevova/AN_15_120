...
//=========  (Mon Oct 26 23:50:09 2015) by ROOT version5.32/00
   ...
   cfail_bf->Range(-150,-12.62049,850,84.46023);
   ...
   TH1D *frame_16bf700__3 = new TH1D("frame_16bf700__3","",40,0,800);
   frame_16bf700__3->SetMaximum(76.69378);
   frame_16bf700__3->SetDirectory(0);
   frame_16bf700__3->SetStats(0);
   frame_16bf700__3->SetFillColor(2);
   frame_16bf700__3->SetFillStyle(0);
   frame_16bf700__3->SetLineStyle(0);
   frame_16bf700__3->SetLineWidth(2);
   frame_16bf700__3->SetMarkerStyle(20);
   frame_16bf700__3->SetMarkerSize(1.2);
   frame_16bf700__3->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_16bf700__3->GetXaxis()->SetNdivisions(505);
   frame_16bf700__3->GetXaxis()->SetLabelFont(42);
   frame_16bf700__3->GetXaxis()->SetLabelSize(0.05);
   frame_16bf700__3->GetXaxis()->SetTitleSize(0.055);
   frame_16bf700__3->GetXaxis()->SetTitleOffset(1.2);
   frame_16bf700__3->GetXaxis()->SetTitleFont(42);
   frame_16bf700__3->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_16bf700__3->GetYaxis()->SetLabelFont(42);
   frame_16bf700__3->GetYaxis()->SetLabelOffset(0.01);
   frame_16bf700__3->GetYaxis()->SetLabelSize(0.05);
   frame_16bf700__3->GetYaxis()->SetTitleSize(0.055);
   frame_16bf700__3->GetYaxis()->SetTitleOffset(1.4);
   frame_16bf700__3->GetYaxis()->SetTitleFont(42);
   frame_16bf700__3->GetZaxis()->SetLabelFont(42);
   frame_16bf700__3->GetZaxis()->SetLabelSize(0.035);
   frame_16bf700__3->GetZaxis()->SetTitleSize(0.035);
   frame_16bf700__3->GetZaxis()->SetTitleFont(42);
   frame_16bf700__3->Draw("");
   ...
   Graph_h_dataFail2->SetMaximum(80.34586);
   ...
   TH1D *frame_16bf700__4 = new TH1D("frame_16bf700__4","",40,0,800);
   frame_16bf700__4->SetMaximum(76.69378);
   frame_16bf700__4->SetDirectory(0);
   frame_16bf700__4->SetStats(0);
   frame_16bf700__4->SetFillColor(2);
   frame_16bf700__4->SetFillStyle(0);
   frame_16bf700__4->SetLineStyle(0);
   frame_16bf700__4->SetLineWidth(2);
   frame_16bf700__4->SetMarkerStyle(20);
   frame_16bf700__4->SetMarkerSize(1.2);
   frame_16bf700__4->GetXaxis()->SetTitle("Top Mass [GeV/c^2]");
   frame_16bf700__4->GetXaxis()->SetNdivisions(505);
   frame_16bf700__4->GetXaxis()->SetLabelFont(42);
   frame_16bf700__4->GetXaxis()->SetLabelSize(0.05);
   frame_16bf700__4->GetXaxis()->SetTitleSize(0.055);
   frame_16bf700__4->GetXaxis()->SetTitleOffset(1.2);
   frame_16bf700__4->GetXaxis()->SetTitleFont(42);
   frame_16bf700__4->GetYaxis()->SetTitle("Events / ( 20 )");
   frame_16bf700__4->GetYaxis()->SetLabelFont(42);
   frame_16bf700__4->GetYaxis()->SetLabelOffset(0.01);
   frame_16bf700__4->GetYaxis()->SetLabelSize(0.05);
   frame_16bf700__4->GetYaxis()->SetTitleSize(0.055);
   frame_16bf700__4->GetYaxis()->SetTitleOffset(1.4);
   frame_16bf700__4->GetYaxis()->SetTitleFont(42);
   frame_16bf700__4->GetZaxis()->SetLabelFont(42);
   frame_16bf700__4->GetZaxis()->SetLabelSize(0.035);
   frame_16bf700__4->GetZaxis()->SetTitleSize(0.035);
   frame_16bf700__4->GetZaxis()->SetTitleFont(42);
   frame_16bf700__4->Draw("AXISSAME");
